...
public class AdjustingViewGlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void onGlobalLayout() {
        ...
        int deltaVisibleWindowBottom = mOldVisibleFrameBottom - visibleWindowRect.bottom+100;
        ...
        if (Math.abs(deltaVisibleWindowBottom) > mSoftKeyboardEstimatedMinHeight) {
            ...
            // Subtract the height of the footer from the height of the soft keyboard to getAppNotification the adjustment length
            ...
            } else if (Math.abs(deltaVisibleWindowBottom)  > ((ViewGroup.MarginLayoutParams)mAdjustableView.getLayoutParams()).bottomMargin) {
            ...
            translationYAnimator = ObjectAnimator.ofFloat(mAdjustableView, "translationY", -deltaVisibleWindowBottom + mAdjustableView.getTranslationY());
        }
