...
public class SharedHelper extends CoreSharedHelper {
  ...
  public class Constants {
    ...
    public static final String PHONE_NUMBER_OILS = "PHONE_NUMBER_OILS";
  ...
  public String getSpinnerPositionForCar() {
    return getPref(Constants.SPINNER_POSITION);
  }

  public void saveSpinnerPositionForCar(String key) {
    savePref(Constants.SPINNER_POSITION, key);
  }
...
//  }
  ...
  public void saveMap(HashMap<String, String> inputMap) {
    String hashMapString = new Gson().toJson(inputMap);
    savePref(Constants.PHONE_NUMBER_OILS, hashMapString);
  }

  public HashMap<String, String> loadMap() {
    String storedHashMapString = getPref(Constants.PHONE_NUMBER_OILS);
